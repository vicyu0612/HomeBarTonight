...
const RECIPE_ID = 'brandy-sidra'
const RAW_FILENAME_PATTERN = 'brandy_sidra_v2'

async function uploadBrandySidra() {
    console.log('Starting Brandy Sidra upload...')
...
uploadBrandySidra().catch(console.error)
