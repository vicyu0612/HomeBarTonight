...
const RECIPE_ID = 'baileys-milktea'
const RAW_FILENAME_PATTERN = 'baileys_boba_tea_v9'

async function uploadBaileys() {
    console.log('Starting Baileys upload...')
...
uploadBaileys().catch(console.error)
